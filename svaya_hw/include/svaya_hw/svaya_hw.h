#ifndef ROS2_SVAYA_HW
#define ROS2_SVAYA_HW
...
void change_op_mode(int exe_flag, bool reached);
    ...
    class SvayaHW : public hardware_interface::SystemInterface
    {
        public:

            void joint_values_callback(const trajectory_msgs::msg::JointTrajectory &msg);
            ...
            void call_back_fun(std::string msg)
            {
              RCLCPP_INFO_STREAM(rclcpp::get_logger("driver"),msg.c_str());
            }
...
//            svaya_driver::SvayaDriver *svaya_driver;
            ...
            rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr motor_torq_pub;
            rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr dc_link_vol_pub;
            rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr target_torq_pub;
            ...
            rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr gc_sens_sub;

            rclcpp::Subscription<trajectory_msgs::msg::JointTrajectory>::SharedPtr trajectory_controller_sub;
