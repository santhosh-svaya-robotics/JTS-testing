...
def generate_launch_description():
    ...
    " ",
    PathJoinSubstitution([FindPackageShare("svaya_description"), "urdf","svaya_aiu_16.urdf.xacro"]),
    ...
    IncludeLaunchDescription(
        PythonLaunchDescriptionSource([PathJoinSubstitution(
            [FindPackageShare('aiu_16_moveit_config'), 'launch', 'move_group.launch.py'])]),
