...
def generate_launch_description():
    ...
    " ",
    PathJoinSubstitution([FindPackageShare("svaya_description"), "urdf","JTS.urdf"]),
...
#    package="torq_predictor",

#    executable="torq_predictor",
#    output="both",
#   # prefix = ["gdb -ex run --args"],
#    )

    sensor_node = Node(
    package="svaya_testing",
    executable="app_main",
    output="both",
    )
...
#    )
    ...
    package="rqt_plot",
    executable="rqt_plot",
    arguments = ['/svaya/model_torq/data[0]', 'svaya/analog_scaled_signal/data'],
#    arguments = ['/svaya/analog_signal/data'],
    output="both",
    )
