...
def generate_launch_description():
    ...
    " ",
    PathJoinSubstitution([FindPackageShare("svaya_description"), "urdf","svaya_aiu_6_v2.urdf.xacro"]),
    ...
    IncludeLaunchDescription(
        PythonLaunchDescriptionSource([PathJoinSubstitution(
            [FindPackageShare('aiu_6_v2_moveit_config'), 'launch', 'move_group.launch.py'])]),
